...
class ApartmentAdminForm(forms.ModelForm):
    description_short_es = forms.CharField(widget=CKEditorUploadingWidget())
    description_short_en = forms.CharField(widget=CKEditorUploadingWidget())
    description_short_de = forms.CharField(widget=CKEditorUploadingWidget())
    description_long_es = forms.CharField(widget=CKEditorUploadingWidget())
    description_long_en = forms.CharField(widget=CKEditorUploadingWidget())
    description_long_de = forms.CharField(widget=CKEditorUploadingWidget())
...
class ImageInline(admin.TabularInline):
    model = Images
    fields = ['apartment', 'image', 'get_preview']
