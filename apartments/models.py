...
class Booking(models.Model):
    ...
    STATUS_CHOICES = (
        ...
        (STATUS_COMPLETED, 'Reserva realizada')
    )
...
# @receiver(post_save, sender=Booking, dispatch_uid="update_stock_count")
# def update_stock(sender, instance, **kwargs):
#     email = SendingEmail()
#     email.sendig_email(type_id=1, order=instance)
#     email.sendig_email(type_id=2, order=instance, email=instance.urer.customer.user.email)
